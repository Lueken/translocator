...
const appEulaSections = (AT_REST_SEALED: boolean): { h: string; p: string }[] => [
  ...
  },
  {
    ...
    p: "Translocator is copyright Lueken Good Design LLC and is released under the GNU General Public License v3.0: the source code is public, and you may read, modify, redistribute, and sell it, provided a modified version you distribute stays GPL-3.0 and ships its source. That covers this launcher's code; it places no restriction on anyone writing a launcher of their own, and the Modpack Hub is a separate service whose source is not published. The full license accompanies the application and the source repository, and this notice is a plain-language summary of it; where they differ, the license controls. The public source also means anyone can verify the claims made above, including how your credentials are handled. Official builds are produced and signed only by Lueken Good Design LLC. Publishing modpacks through Translocator does not transfer any rights in the referenced mods, which remain subject to their authors' licenses.",
  },
  {
